            ...
            3 -> PermissionStep(
                ...
                onRequest = {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                        // Activity result launcher would be needed here
    ...
    Column(
        ...
        if (!granted) {
            ...
            TextButton(onClick = onNext) {
                Text("Skip for now", color = Color(0xFFB0B0B0))
            }
        } else {
            Button(
                onClick = onNext,
...
fun GroqSetupStep(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            placeholder = {
                Text(
                    "ECE — signals, op-amps; LLMs; Android dev",
        ...
        TextButton(onClick = onSkip) {
            Text("Skip — use built-in cards", color = Color(0xFFB0B0B0))
        }
